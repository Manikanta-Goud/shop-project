-- ============================================
-- OFFERS TABLE - COMPLETE SETUP
-- ============================================
-- Run this ONCE in Supabase SQL Editor
-- Works for both development and when you're ready to deploy
...
-- Disable security for easy management (you can enable later if needed)
alter table offers disable row level security;

-- Auto-update timestamp when offer is edited
...
-- Add sample data to test (optional - delete these later from admin portal)
