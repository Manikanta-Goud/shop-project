            ...
            <main className="max-w-7xl mx-auto px-4 py-12 lg:py-20 mt-10">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-gold/10 pb-8">
                    ...
                    <div className="bg-secondary/40 border border-gold/20 px-6 py-4 rounded-2xl flex items-center gap-4">
                        <div className="text-center">
                            <span className="text-[10px] text-gold-light/40 uppercase tracking-widest block font-bold">Basket Items</span>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                        ...
                        <div className="xl:col-span-8 space-y-6">
                                                    ...
                                                    <div className="flex-1 flex flex-col justify-between">
                                                        <div className="flex justify-between items-start gap-2">
                                                            <div className="cursor-pointer" onClick={() => navigate(`/product/${item.product_id}`)}>
                                                                <h3 className="font-display text-xl text-primary-foreground font-bold leading-snug">
                                                                    {item.products.name}
                                                                </h3>
                                                                <p className="text-gold-light/50 text-xs uppercase tracking-widest font-bold mt-1">
                                                                    {item.products.category} • {item.products.type}
                                                                </p>
                                                            </div>
                                                            <button
                                                                onClick={() => removeFromCart(item.id)}
                                                                className="text-gold-light/30 hover:text-red-500 transition-colors p-1"
                                                            >
                                                                <Trash2 size={18} />
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                                                            <div className="flex items-center gap-3 border border-gold/30 rounded-full px-3 py-1.5 bg-primary/20 backdrop-blur-sm">
                                                                ...
                                                                <span className="font-display font-bold text-lg text-primary-foreground min-w-[20px] text-center">
                                                                    {item.quantity}
                                                                </span>
                                                                <button
                                                                    onClick={() => updateQuantity(item.id, item.quantity + 1)}
                                                            ...
                                                            <div className="text-right">
                                                                ...
                                                                <p className="text-gold-light/40 text-[10px] italic">Price per unit</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-10">
                                <div className="flex items-center gap-3 text-gold-light/60 p-4 border border-gold/10 rounded-2xl bg-secondary/10">
                            ...
                            <Card className="bg-secondary/40 border-gold/30 shadow-gold-lg overflow-hidden sticky top-32">
                                <CardContent className="p-8">
                                    ...
                                    <div className="flex justify-between items-end mb-8">
                                        <div>
                                            <p className="text-[10px] text-gold-light/40 uppercase tracking-widest font-bold mb-1">Total Treasury Investment</p>
                                    ...
                                    <Button className="w-full bg-gold-gradient text-accent-foreground font-display font-bold h-14 uppercase tracking-[0.2em] rounded-xl shadow-gold hover:shadow-gold-lg hover:scale-[1.02] transition-all">
                                        Secure Checkout
                                    </Button>

                                    <div className="mt-8 flex items-center justify-center gap-2 text-gold-light/40 font-body text-[10px] uppercase tracking-widest">
                                    ...
                                    {shipping > 0 && (
                                        <p className="text-[10px] text-center text-gold-light/50 mt-4 italic">
                    ...
                    <div className="text-center py-20 bg-secondary/10 rounded-3xl border border-dashed border-gold/20">
                        ...
                        <p className="text-gold-light/60 font-body mb-8">Your cart feels a bit light. Let's add some royal heritage.</p>
